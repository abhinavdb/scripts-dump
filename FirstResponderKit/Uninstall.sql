...
-- Drop tables
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzCache]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzCache]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzFirst]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzFirst]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzFirst_FileStats]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzFirst_FileStats]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzFirst_PerfmonStats]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzFirst_PerfmonStats]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzFirst_WaitStats]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzFirst_WaitStats]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzFirst_WaitStats_Categories]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzFirst_WaitStats_Categories]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[BlitzWho]') AND type in (N'U'))
DROP TABLE [dbo].[BlitzWho]
GO
